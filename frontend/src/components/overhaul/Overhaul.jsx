...
import {
    ...
    getWallWorkCapServices, postApplication, resetIsLoaded
} from "../../store/apiSlice";
            ...
            <div className="overhaul-services-container">
                ...
                <div className="overhaul-services-list">
                    {services.map((service, index) => (
                        <div key={index}>
                            <ExpandableBlock title={service.name} number={service.number}
                ...
                <div className="overhaul-form-wrapper">
                    ...
                    <div className="overhaul-form-container">
                        ...
                        <div className="overhaul-form-left">
                            <input type="text" className="overhaul-form-input" placeholder="Имя*" name="name" value={application.name} onChange={handleChange} required/>
                            <input type="text" className="overhaul-form-input" placeholder="Номер телефона*" name="phone_number" value={application.phone_number} onChange={handleChange} required/>
                            <input type="email" className="overhaul-form-input" placeholder="Электронная почта*" name='email' value={application.email} onChange={handleChange}/>
                        </div>

                        {/* Правая колонка с полем сообщения */}
                        <div className="overhaul-form-right">
                            <textarea className="overhaul-form-textarea" rows="4" placeholder="Сообщение*" name="content" value={application.content} onChange={handleChange} required></textarea>
                        </div>
                    </div>
